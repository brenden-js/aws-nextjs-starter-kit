...
function MobileNavLink({
  ...
  return (
    <Popover.Button
      as={Link}
      href={href}
      className="block w-full p-2 text-gray-300 hover:text-white transition-colors"
    >
      {children}
    </Popover.Button>
  );
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 pt-40 pb-24">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-1/4 -left-1/4 h-[500px] w-[500px] rounded-full bg-purple-500/10 blur-3xl animate-pulse"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center animate-fade-in">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-300">
            A complete starter template with authentication, payments,
            background jobs, and type-safe APIs. Built with Next.js, AWS, and
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Start with a fully configured development environment and
            production-ready infrastructure. Focus on building your product, not
            setting up tooling.
          </p>
        </motion.div>
        <motion.div
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Includes a complete example application showcasing integration
              patterns and best practices. Use it as a reference or starting
